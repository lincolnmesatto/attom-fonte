...
--
-- Máquina: localhost
-- Data de Criação: 19-Abr-2021 às 21:57
...
(9, 'Harry Potter', 1, 7, 7, 1, NULL, 4),
(12, 'teste', 1, 10, 10, 1, 1, 1);
...
--
-- Extraindo dados da tabela `tb_selo`
--

INSERT INTO `tb_selo` (`cod_selo`, `cod_editora`, `descricao`) VALUES
(1, 1, 'Tsuru');
